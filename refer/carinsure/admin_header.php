<nav class="navbar">
    <a href="home.php" class="navbar-brand">
        <h2 class="m-0 text-primary"><i class="fa fa-car me-3"></i>Admin</h2>

        <?php
        if (isset($_SESSION['adminid'])) {
            echo '
            <strong><p id = "loginname"><span>' . $_SESSION['adminname'] . '</span><a href="logout.php" class="power-button">
    ...
    <div class="navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav">
            <a href="admin_page.php" class="nav-item active">Home</a>
            <a href="admin_account.php" class="nav-item">Account</a>
            <a href="admin_insurance.php" class="nav-item">Insurance</a>
